        ...
        <div className="w-full md:w-1/2 p-0 md:p-10 flex flex-col justify-center text-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative pb-2">
              ...
              />
              {errors.email && (
                <p className="absolute left-1/2 -translate-x-1/2 -bottom-1 z-20 px-3 py-0 text-[14px] font-bold text-red-600 bg-white rounded-md border border-red-200 shadow-sm transition-all duration-300 mt-0 translate-y-2 md:translate-y-2 whitespace-nowrap leading-tight">
                  {errors.email}
                </p>
              )}
            </div>
            ...
            <div className="relative pb-2">
              <div
                className={`flex items-center justify-center gap-3 bg-[#1e1a3d]/70 p-2.5 rounded-full border-2 ${errors.userAnswer ? "border-red-500" : "border-transparent"}`}
              >
